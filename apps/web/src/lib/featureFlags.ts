...
/** InterwovenKit wallet UI. Disabled by default until the provider path is stable on production. */
export const ENABLE_INTERWOVEN_KIT =
  process.env.NEXT_PUBLIC_CHAIN_ENV === "initia-testnet" &&
  process.env.NEXT_PUBLIC_ENABLE_INTERWOVEN_KIT === "true";
...
export const ENABLE_AUTOSIGN =
  ENABLE_INTERWOVEN_KIT && process.env.NEXT_PUBLIC_ENABLE_AUTOSIGN === "true";
