...
describe(
  ...
  () => {
    ...
    test(
      "both agents complete 1 hand (handId advances to > 1)",
      async () => {
        ...
        // Give agents time to authenticate and register encryption keys before the keeper starts the hand.
    ...
    test(
      "game state returns to SETTLED (10) or WAITING_FOR_SEATS (0) after hand",
      async () => {
